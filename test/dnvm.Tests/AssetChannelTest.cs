...
namespace DotNet.VersionManager.Test
{
    public class AssetChannelTest
    {
        ...
        [InlineData("1.0.0-rc4-004915", "https://dotnetcli.azureedge.net/dotnet/Sdk/1.0.0-rc4-004915/dotnet-dev-osx-x64.1.0.0-rc4-004915.tar.gz")]
        ...
        [InlineData("Microsoft.DotNet.Cli.osx-x64", "1.0.0-rc4-004915")]
